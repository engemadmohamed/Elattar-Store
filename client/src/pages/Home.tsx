...
export default function Home() {
  ...
  const mainCategories = categories?.filter((c) => !c.slug.includes("-")) || categories?.slice(0, 6);
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 rounded-full border bg-background/80 px-3 py-1 text-sm text-primary mb-4 shadow-sm">
              ...
              متجر العطار الأول للأدوات المكتبية في مصر
            </div>
      ...
      {/* Best Sellers */}
      <ProductSection title="الأكثر مبيعًا" query="sort=best_selling" limit={8} />

      {/* Discounts */}
      <ProductSection title="عروض وخصومات" query="onSale=true" limit={8} bgMuted />
